			...
			<Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
				<DialogContent>
					<DialogHeader>
						...
						<DialogDescription>
							Add a new item to the {CATEGORY_TYPES[formData.type]} category.
						</DialogDescription>
					</DialogHeader>
							...
							<div className="grid grid-cols-4 items-center gap-4">
								...
								<div className="col-span-3">
									...
									<p className="text-xs text-gray-500 mt-1">
										Shown as tooltip on (i) icon for priorities
									</p>
								</div>
							</div>
						)}
			...
			<Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
				<DialogContent>
					<DialogHeader>
						...
						<DialogDescription>
							Update this item in the {CATEGORY_TYPES[formData.type]} category.
						</DialogDescription>
					</DialogHeader>
				...
				<AlertDialogContent>
					<AlertDialogHeader>
						...
						<AlertDialogDescription>
							...
							{currentCategory && CATEGORY_TYPES[currentCategory.type]} category. This action cannot be
							undone.
						</AlertDialogDescription>
					</AlertDialogHeader>
					<AlertDialogFooter>
