...
export default function MultiSelectFilter({ label, options, selected, onChange, disabled }) {
	const { t } = useI18n();
	...
	return (
		<DropdownMenu>
			<DropdownMenuTrigger asChild>
				<Button variant="outline" className="w-full sm:w-[180px] justify-between" disabled={disabled}>
