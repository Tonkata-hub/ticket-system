                ...
                {editMode ? (
                    <>
                        <div className="flex items-center">
                            <Select value={editedTicket.statusBadge} onValueChange={(value) => onSelectChange("statusBadge", value)}>
                    ...
                    <>
                        ...
                        <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                            <Badge className={`${priorityColor[editedTicket.priority]} capitalize`}>{editedTicket.priority}</Badge>
                        </motion.div>
                    </>
                )}
            </div>
